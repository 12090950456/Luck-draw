...
class Page{
    ...
    public function show() {
        ...
        $link_page.="<li><span style='border: 0;'>跳转至</span><input style='width: 30px;' value='".$this->nowPage."' class='pinput' id='pnumber' type='number'><input onclick=goPage('".$this->url."') class='pinput' type='button' value='确定'></li>";
        //替换分页内容
